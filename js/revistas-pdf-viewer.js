...
// 1. Obtén el nombre del archivo HTML actual.
// Por ejemplo, si la URL es https://midominio.com/miCarpeta/202303.html
// window.location.pathname podría ser "/miCarpeta/202303.html".
const fullPath = window.location.pathname;             
// "202303.html"
const currentHtmlFileName = fullPath.split('/').pop(); 
// "202303"
const fileBaseName = currentHtmlFileName.replace('.html', ''); 

// 2. Construye la URL al PDF
const pdfUrl = `https://conexionmx.s3.us-east-2.amazonaws.com/pdf/${fileBaseName}.pdf`;

// 3. Continúa con tu código habitual
// Elementos del DOM
...
function loadPdf() {
  showProgressBar(); // Muestra la barra de progreso de descarga
